...
<head>
    ...
    <title>Διαδικασία και δικαιολογητικά υποβολής αίτησης για κατ’ εξαίρεση εξέταση εξ’ αποστάσεως, σε μαθήματα που εξετάζονται με φυσική παρουσία</title>
...
<div id="main">
    <table id="table" align="center" border="0">
        <tr>
            ...
            <td class="td-title"><h4><?php echo $title?></h4><p><?php echo $description?></p></td>
        </tr>
    </table>
</div>
