...
<head>
    ...
    <title>Μονιμοποίηση Επίκουρου Καθηγητή στο γνωστικό αντικείμενο "Αλγόριθμοι και Πολυπλοκότητα"</title>
            ...
            foreach ($connection->query($sql) as $row) {
                if ($row["id"]==4){
                    ...
                    <tr>
                        ...
                        <td class="td-title"><h4><?php echo $obj->getTitle()?></h4><p><?php echo $obj->getDescription()?></p><a href="istoriko-monimopoihshs.xls" target="_blank">istoriko-monimopoihshs.xls</a></td>
                    </tr>
                    <?php
                }
            }
