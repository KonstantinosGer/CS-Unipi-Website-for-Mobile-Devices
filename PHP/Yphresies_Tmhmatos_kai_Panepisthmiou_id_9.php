...
<div id="main">
    <h2>GUNET</h2>
    <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_9.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Η πλατφόρμα GUNet eClass αποτελεί ένα ολοκληρωμένο Σύστημα Διαχείρισης Ηλεκτρονικών Μαθημάτων. Ακολουθεί τη φιλοσοφία του λογισμικού ανοικτού κώδικα και υποστηρίζει την υπηρεσία Ασύγχρονης Τηλεκπαίδευσης χωρίς περιορισμούς και δεσμεύσεις. Η πρόσβαση στην υπηρεσία γίνεται με τη χρήση ενός απλού φυλλομετρητή (web browser) χωρίς την απαίτηση εξειδικευμένων τεχνικών γνώσεων.</p><br>
    <a href="https://gunet2.cs.unipi.gr/"><p>GUNet eClass - Πλατφόρμα Ασύγχρονης Τηλεκπαίδευσης</p></a>
    <br><br><br><br>
</div>
