...
<div id="main">
    <h2>Συνεργαζόμενες εταιρίες</h2><br>
    <table id="table" border = "0"; style="width: 100%; border-collapse: separate; border-spacing: 50px 0;">
        <tr>
            <td style="width: 40%;">
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_11.php"><h3 style="text-align: left">MSDNAA</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_11.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr style="margin-left: 20px;">
            <td>
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_1.php"><h3>Oracle Academy</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_1.jpg" width="150" height="150" >
            </td>
        </tr>
    </table>
</div>
