...
<head>
    ...
    <title>Ανακοίνωση για επαναπροκήρυξη εκλογών για την ανάδειξη Προέδρου και Αναπληρωτή Προέδρου του Τμήματος Πληροφορικής για θητεία δυο (2) ετών, από 01/09/2020 έως 31/08/2022</title>
...
<div id="main">
    <table id="table" align="center" border="0">
        <tr>
            <td class="td-date"><b style="background-color: #3b5998; color: #f2f2f2; font-size: 16px;"><?php echo $article_date?></b></td>
            <td class="td-title"><h4><?php echo $title?></h4><p><?php echo $description?></p><a href="_ΓΙΑ_ΕΠΑΝΑΠΡΟΚΗΡΥΞΗ_ΕΚΛΟΓΩΝ_ΤΜ_ΠΛΗΡΟΦΟΡΙΚΗΣ.pdf" target="_blank">Αρχείο Ανακοίνωσης</a></td>
        </tr>
    </table>
</div>
