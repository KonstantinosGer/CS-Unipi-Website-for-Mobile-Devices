...
<div id="main">
    <h2>STUDENTS</h2>
    <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_10.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Υπηρεσία Πληροφόρησης Φοιτητών. Προγράμματα σπουδών, δηλώσεις, αιτήσεις, βαθμολογία.</p><br>
    <a href="https://students.unipi.gr/login.asp"><p>STUDENTS - Υπηρεσία Πληροφόρησης Φοιτητών</p></a>
