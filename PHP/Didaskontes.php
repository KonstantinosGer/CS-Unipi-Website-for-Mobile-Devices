...
<head>
    ...
    <style>
        ...
        #table td, #table2 td, #table3 td, #table4 td, #table5 td, #table6 td {
            font-size: 16px;
            font-family: inherit;
...
<div id="main">
    ...
    <!--Πρόεδρος Τμήματος-->
    <h3>Πρόεδρος Τμήματος</h3>
    <table id="table" align="center" border="0" style="width: 60%;">
        <?php
        try {
            #Connect to database
            $connection = new PDO("pgsql:host=localhost;dbname=cs_unipi_database", "postgres", "polifolio68");
            #Query
            $sql = 'SELECT * from didaskontes';

            foreach ($connection->query($sql) as $row) {
                #Create new object
                if ($row["position"]=="proedros"){
                    $obj = new Didaskontes();
                    ...
                    ?>
                    <tr>
                        <td class="td-image"><img src="user_icon_transparent.png" alt="image_proedros" width="60" height="60"></td>
                        <td class="td-title"><h4><?php echo $obj->getName()?></h4><p><?php echo $obj->getDescription()?></p></td>
                    </tr>
                    <?php
                }
            }
    ...
    <h3>Αναπληρωτής Πρόεδρος Τμήματος</h3>
    <table id="table2" align="center" border="0" style="width: 60%;">
        <?php
        try {
            #Connect to database
            $connection = new PDO("pgsql:host=localhost;dbname=cs_unipi_database", "postgres", "polifolio68");
            ...
            foreach ($connection->query($sql) as $row) {
                #Create new object
                if ($row["position"]=="anaplhrwths_proedros"){
                    $obj = new Didaskontes();
                    $obj->setName($row["name"]);
                    $obj->setDescription($row["description"]);
                    $obj->setPosition($row["position"]);
                    ...
                    ?>
                    <tr>
                        <td class="td-image"><img src="user_icon_transparent.png" alt="image_anaplhrwths_proedros" width="60" height="60"></td>
                        <td class="td-title"><h4><?php echo $obj->getName()?></h4><p><?php echo $obj->getDescription()?></p></td>
                    </tr>
                    <?php
                }
    ...
    <!--Καθηγητές-->
    <h3>Καθηγητές</h3>
    <table id="table3" align="center" border="0" style="width: 60%;">
        <?php
        try {
            #Connect to database
            $connection = new PDO("pgsql:host=localhost;dbname=cs_unipi_database", "postgres", "polifolio68");
            ...
            foreach ($connection->query($sql) as $row) {
                #Create new object
                if ($row["position"]=="proedros" || $row["position"]=="kathhghths"){
                    $obj = new Didaskontes();
                    $obj->setName($row["name"]);
                    $obj->setDescription($row["description"]);
                    $obj->setPosition($row["position"]);
                    ...
                    ?>
                    <tr>
                        <td class="td-image"><img src="user_icon_transparent.png" alt="image_kathhghths" width="60" height="60"></td>
                        <td class="td-title"><h4><?php echo $obj->getName()?></h4><p><?php echo $obj->getDescription()?></p></td>
                    </tr>
                    <?php
                }
    ...
    <h3>Αναπληρωτές Καθηγητές</h3>
    <table id="table4" align="center" border="0" style="width: 60%;">
        <?php
        try {
            #Connect to database
            $connection = new PDO("pgsql:host=localhost;dbname=cs_unipi_database", "postgres", "polifolio68");
            ...
            foreach ($connection->query($sql) as $row) {
                #Create new object
                if ($row["position"]=="anaplhrwths_kathhghths"){
                    $obj = new Didaskontes();
                    $obj->setName($row["name"]);
                    $obj->setDescription($row["description"]);
                    $obj->setPosition($row["position"]);
                    ...
                    ?>
                    <tr>
                        <td class="td-image"><img src="user_icon_transparent.png" alt="image_anaplhrwths_kathhghths" width="60" height="60"></td>
                        <td class="td-title"><h4><?php echo $obj->getName()?></h4><p><?php echo $obj->getDescription()?></p></td>
                    </tr>
                    <?php
                }
    ...
    <!--Επίκουροι Καθηγητές-->
    <h3>Επίκουροι Καθηγητές</h3>
    <table id="table5" align="center" border="0" style="width: 60%;">
        <?php
        try {
            #Connect to database
            $connection = new PDO("pgsql:host=localhost;dbname=cs_unipi_database", "postgres", "polifolio68");
            ...
            foreach ($connection->query($sql) as $row) {
                #Create new object
                if ($row["position"]=="epikouros_kathhghths"){
                    $obj = new Didaskontes();
                    $obj->setName($row["name"]);
                    $obj->setDescription($row["description"]);
                    $obj->setPosition($row["position"]);
                    ...
                    ?>
                    <tr>
                        <td class="td-image"><img src="user_icon_transparent.png" alt="image_epikouros_kathhghths" width="60" height="60"></td>
                        <td class="td-title"><h4><?php echo $obj->getName()?></h4><p><?php echo $obj->getDescription()?></p></td>
                    </tr>
                    <?php
                }
    ...
    <!--Ομότιμοι Καθηγητές-->
    <h3>Ομότιμοι Καθηγητές</h3>
    <table id="table6" align="center" border="0" style="width: 60%;">
        <?php
        try {
            #Connect to database
            $connection = new PDO("pgsql:host=localhost;dbname=cs_unipi_database", "postgres", "polifolio68");
            ...
            foreach ($connection->query($sql) as $row) {
                #Create new object
                if ($row["position"]=="omotimos_kathhghths"){
                    $obj = new Didaskontes();
                    $obj->setName($row["name"]);
                    $obj->setDescription($row["description"]);
                    $obj->setPosition($row["position"]);
                    ...
                    ?>
                    <tr>
                        <td class="td-image"><img src="user_icon_transparent.png" alt="image_omotimos_kathhghths" width="60" height="60"></td>
                        <td class="td-title"><h4><?php echo $obj->getName()?></h4><p><?php echo $obj->getDescription()?></p></td>
                    </tr>
                    <?php
                }
