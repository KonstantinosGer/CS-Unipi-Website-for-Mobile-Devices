...
<div id="main">
    <h2>Διδακτορικό Πρόγραμμα Σπουδών</h2>
    <p>Το διδακτορικό πρόγραμμα του Τμήματος έχει στόχο τη διεξαγωγή έρευνας υψηλής ποιότητας και την άρτια εκπαίδευση των νέων ερευνητών, σύμφωνα με τα διεθνή πρότυπα της επιστήμης της Πληροφορικής.</p>
    <h3>Αίτηση και διαδικασία εγγραφής</h3>
    <p>Οι υποψήφιοι υποβάλλουν αίτηση προς τη ΓΣΕΣ στη Γραµµατεία του Τµήµατος. Η Γραµµατεία ελέγχει αν οι υποψήφιοι έχουν τα τυπικά προσόντα συµµετοχής, όπως αυτά προβλέπονται από την ισχύουσα νοµοθεσία και από τον παρόντα Κανονισµό του ΠΜΣ και διαβιβάζει τις αιτήσεις των υποψηφίων, µαζί µε τα δικαιολογητικά που έχουν υποβληθεί στη ΓΣΕΣ, η οποία αποφασίζει αν θα κάνει δεκτούς στο Τµήµα τους υποψήφιους διδάκτορες. Ακολούθως, εάν η αίτηση γίνει δεκτή, η ΓΣΕΣ ορίζει τον επιβλέποντα καθηγητή σύμφωνα µε την αίτηση του υποψηφίου και συγκροτεί την Τριµελή Συµβουλευτική Επιτροπή του υποψήφιου, σύµφωνα µε την πρόταση του επιβλέποντός του.</p>
    <p>Η ΓΣΕΣ έχει τη δυνατότητα να προκηρύξει εκδήλωση ενδιαφέροντος για θέσεις υποψηφίων διδακτόρων σε συγκεκριµένα γνωστικά αντικείµενα. Η σχετική εκδήλωση ενδιαφέροντος δηµοσιεύεται στον ηµερήσιο τύπο, στους πίνακες ανακοινώσεων του Τµήµατος, καθώς και ηλεκτρονικά.</p>
    <h3>Προϋποθέσεις συμμετοχής</h3>
    <p>Για την εκπόνηση διδακτορικής διατριβής οι υποψήφιοι πρέπει να πληρούν τις παρακάτω προϋποθέσεις:</p>
    <ol>
        <li>Να είναι πτυχιούχοι Τμημάτων Α.Ε.Ι. (Πανεπιστημίων και Τ.Ε.Ι). της ημεδαπής ή αναγνωρισμένων ομοταγών ιδρυμάτων της αλλοδαπής.</li>
        <li>Να είναι κάτοχοι Μεταπτυχιακού Διπλώματος Ειδίκευσης ή κάτοχοι ισότιµου Μεταπτυχιακού ∆ιπλώµατος Ειδίκευσης Πανεπιστηµιακών Τµηµάτων της ηµεδαπής ή αναγνωρισµένων οµοταγών πανεπιστηµιακών ιδρυµάτων της αλλοδαπής. Για τους κατόχους µεταπτυχιακού τίτλου σπουδών από πανεπιστηµιακό ίδρυµα της αλλοδαπής, είναι απαραίτητη η αναγνώριση του τίτλου αυτού από το ∆ΟΑΤΑΠ.</li>
        <li>Να έχουν επαρκή γνώση της αγγλικής γλώσσας που να πιστοποιείται είτε µε πλήρη κύκλο σπουδών στο εξωτερικό ή τουλάχιστον πιστοποιητικό γλωσσοµάθειας αντίστοιχο του First Certificate.</li>
    </ol>
    <h3>Απαιτούμενα δικαιολογητικά</h3>
    <ol>
        <li>Αίτηση του ενδιαφερομένου.</li>
        <li>Αναλυτικό βιογραφικό σημείωμα.</li>
        <li>Πρώτο πτυχίο σε οποιαδήποτε ειδικότητα από αναγνωρισμένο εκπαιδευτικό Ίδρυμα.</li>
        <li>Μεταπτυχιακό δίπλωμα τύπου Μάστερ (ΜΒΑ, Μ.Sc.), σε συναφές αντικείμενο, από αναγνωρισμένο εκπαιδευτικό 'Ιδρυμα.</li>
        <li>Αναλυτική βαθμολογία από τις προπτυχιακές και μεταπτυχιακές σπουδές.</li>
        <li>Απόδειξη γλωσσομάθειας της Αγγλικής Γλώσσας.</li>
    </ol>
</div>
