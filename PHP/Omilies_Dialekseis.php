...
<div id="main">
    <h2>Ομιλίες, διαλέξεις</h2>
    <p>Στο Τμήμα Πληροφορικής έχουν πραγματοποιηθεί οι παρακάτω ομιλίες και διαλέξεις:</p><br>
    <a href="Omilies_Dialekseis_1.php"><h3>Information-Centric Networking: Overview, Current State and Key Challenges</h3></a>
    <p>Pavlou George: "Information-Centric Networking: Overview, Current State and Key Challenges" Ομιλία στο πλαίσιο του 4th International Conference on Intelligence Interactive Multimedia Systems and Services & 3rd KES International Conference on…</p>
    <br><br><br><br><br>
</div>
