...
<div id="main">
    <h2>Information-Centric Networking: Overview, Current State and Key Challenges</h2>
    <p>Pavlou George: "Information-Centric Networking: Overview, Current State and Key Challenges"</p>
    <p>Ομιλία στο πλαίσιο του 4th International Conference on Intelligence Interactive Multimedia Systems and Services & 3rd KES International Conference on Intelligent Decision Technologies.</p>
    <p>Για να την παρακολουθήσετε από το blod του Ιδρύματος Μποδοσάκη, κάντε κλικ <a href="https://www.blod.gr/lectures/information-centric-networking-overview-current-state-and-key-challenges/" target="_blank">εδώ</a>.</p>
    <br><br><br><br><br>
</div>
