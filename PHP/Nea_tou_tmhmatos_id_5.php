...
<head>
    ...
    <title>Πρόγραμμα Εξεταστικής Εαρινού Εξάμηνου Ακαδ. Έτους 2019-2020</title>
...
<div id="main">
    <table id="table" align="center" border="0">
        <tr>
            ...
            <td class="td-title"><h4><?php echo $title?></h4><p><?php echo $description?></p><a href="pli_programma_eksetastikis_062020.pdf" target="_blank">Πρόγραμμα Εξεταστικής Εαρινού Εξάμηνου Ακαδ. Έτους 2019-2020</a></td>
        </tr>
    </table>
</div>
