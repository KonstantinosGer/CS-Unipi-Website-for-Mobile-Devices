...
<div id="main">
    <h2>Γρ. Διασύνδεσης</h2>
    <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_8.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Βασική επιδίωξη του Γραφείου Διασύνδεσης είναι η πολύπλευρη υποστήριξη των φοιτητών/αποφοίτων για την ομαλή ένταξή τους στην αγορά εργασίας και για την ανάπτυξη επιτυχημένης σταδιοδρομίας. Το Γραφείο Διασύνδεσης προωθεί την ανάπτυξη δυναμικών συνεργασιών και την εξυπηρέτηση τεσσάρων πόλων: των Φοιτητών & Αποφοίτων του Πανεπιστημίου, του Διδακτικού & Ερευνητικού Προσωπικού του Πανεπιστημίου, των Επιχειρήσεων & Φορέων προώθησης απασχόλησης και της Δευτεροβάθμιας Εκπαίδευσης.</p><br>
    <a href="https://career.unipi.gr/"><p>Γραφείο Διασύνδεσης Πανεπιστημίου Πειραιά</p></a>
    <br>
</div>
