...
<div id="main">
    ...
    <p>Τα ερευνητικά ενδιαφέροντα των ακαδημαϊκών μελών του Τμήματος καλύπτουν τους κυριότερους τομείς της Επιστήμης της Πληροφορικής. Οι τομείς αυτοί προσδιορίζονται από τις ακόλουθες περιοχές ερευνητικής δραστηριότητας:</p>
    <ul>
        <li>Θεωρία Αλγορίθμων και Υπολογισμού</li>
        <li>Συνδυαστική ανάλυση</li>
        <li>Τεχνολογία Λογισμικού</li>
        <li>Ευφυή Εικονικά Περιβάλλοντα</li>
        <li>Κρυπτογραφία</li>
        <li>Θεωρία Γραφημάτων</li>
        <li>Υπολογιστική Γεωμετρία</li>
        <li>Υπολογιστική Λογική</li>
        <li>Γλώσσες Προγραμματισμού</li>
        <li>Παράλληλοι και Κατανεμημένοι Αλγόριθμοι</li>
        <li>Δίκτυα Υπολογιστών</li>
        <li>Συστήματα Βάσεων Δεδομένων</li>
        <li>Κινητά Υπολογιστικά Συστήματα</li>
        <li>Ασφάλεια Πληροφοριακών Συστημάτων</li>
        <li>Τεχνητή Νοημοσύνη</li>
        <li>Νευρωνικά Δίκτυα</li>
        <li>Αναγνώριση Προτύπων</li>
        <li>Επιστημονικοί Υπολογισμοί</li>
        <li>Γραφικά</li>
        <li>Επεξεργασία Σήματος</li>
        <li>Επεξεργασία Εικόνας</li>
        <li>Βελτιστοποίηση</li>
        <li>Σχεδίαση και Ελεγχος Ολοκληρωμένων Κυκλωμάτων</li>
        <li>Αρχιτεκτονική Υπολογιστών</li>
    </ul>
</div>
