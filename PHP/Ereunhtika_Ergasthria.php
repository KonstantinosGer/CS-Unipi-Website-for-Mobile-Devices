...
<head>
    ...
    <title>Ερευνητικά Εργαστήρια</title>
...
<div id="main">
    <h2>Ερευνητικά Εργαστήρια</h2>
    <p>Στο Τμήμα Πληροφορικής λειτουργούν τα παρακάτω θεσμοθετημένα ερευνητικά εργαστήρια:</p><br>
    <a href="Ereunhtiko_Ergasthrio_id_1.php"><h3>Εργαστήριο Διακριτών Μαθηματικών και Θεωρητικής Πληροφορικής</h3></a>
    <img src="Ereynitika_Ergastiria_id_1.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Διευθυντής: Επίκουρος Καθηγητής Χ. Κωνσταντόπουλος</p>
    <p>Διεύθυνση: Αίθουσα 001, κεντρικό κτίριο</p><br><br><br><br><br>
    <a href="Ereunhtiko_Ergasthrio_id_2.php"><h3>Εργαστήριο Αναγνώρισης Προτύπων και Μηχανικής Μάθησης - Πολυμέσων</h3></a>
    <img src="Ereynitika_Ergastiria_id_2.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Διευθυντής: Καθηγητής Γ. Τσιχριντζής</p>
    <p>Διεύθυνση: Αίθουσα 207, κεντρικό κτίριο</p><br><br><br><br><br><br>
    <a href="Ereunhtiko_Ergasthrio_id_3.php"><h3>Εργαστήριο Ασφάλειας</h3></a>
    <img src="Ereynitika_Ergastiria_id_3.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Διευθύντρια: Αναπληρώτρια Καθηγήτρια Αν. Πολέμη</p>
    <p>Διεύθυνση: Αίθουσα 502, κεντρικό κτίριο</p><br><br><br><br><br>
    <a href="Ereunhtiko_Ergasthrio_id_4.php"><h3>Εργαστήριο Ενσωματωμένων Υπολογιστικών Συστημάτων</h3></a>
    <img src="Ereynitika_Ergastiria_id_4.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Διευθυντής: Επίκουρος Καθηγητής Μ. Ψαράκης</p>
    <p>Διεύθυνση: Αίθουσα 205, κεντρικό κτίριο</p><br><br><br><br><br>
    <a href="Ereunhtiko_Ergasthrio_id_9.php"><h3>Εργαστήριο Τεχνητής Νοημοσύνης και Εικονικής Πραγματικότητας</h3></a>
    <img src="Ereynitika_Ergastiria_id_9.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Διευθυντής: Καθηγητής Θεμιστοκλής Παναγιωτόπουλος</p>
    <p>Διεύθυνση: Αίθουσα 212, κεντρικό κτίριο</p><br><br><br><br><br>
    <a href="Ereunhtiko_Ergasthrio_id_5.php"><h3>Εργαστήριο Διαδικτυακών και Τηλεπικοινωνιακών Συστημάτων Υπηρεσιών και Ασφάλειας</h3></a>
    <img src="Ereynitika_Ergastiria_id_5.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Διευθυντής: Καθηγητής Χρήστος Δουληγέρης</p>
    <p>Διεύθυνση: Αίθουσα 208, κεντρικό κτίριο</p><br><br><br><br><br>
    <a href="Ereunhtiko_Ergasthrio_id_8.php"><h3>Εργαστήριο Τεχνολογίας Λογισμικού</h3></a>
    <img src="Ereynitika_Ergastiria_id_8.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Το εργαστήριο Τεχνολογίας Λογισμικού έχει ως κύριο στόχο την προώθηση της βασικής έρευνας και της υψηλής ποιότητας διδασκαλίας σε καίρια και σύγχρονα θέματα της Τεχνολογίας Λογισμικού, Εκπαιδευτικού Λογισμικού, Μοντελοποίησης χρηστών, Μηχανικής μάθησης και Αναγνώρισης προτύπων, Ανάλυσης Εικόνας, Τεχνητής Αίσθησης και Διαδικτυακής Νοημοσύνης.</p>
    <p>Διευθύντρια: Καθηγήτρια Μαρία Βίρβου</p>
    <p>Διεύθυνση: Αίθουσα 207, Κεντρικό Κτίριο</p><br><br>
    <a href="Ereunhtiko_Ergasthrio_id_7.php"><h3>Εργαστήριο Συστημάτων Υποστήριξης Αποφάσεων</h3></a>
    <img src="Ereynitika_Ergastiria_id_7.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Το Εργαστήριο Συστημάτων Υποστήριξης Αποφάσεων ιδρύθηκε στο Τμήμα Πληροφορικής του Πανεπιστήμιου Πειραιώς το έτος 2001 (ΠΔ 244/2001 – ΦΕΚ Α 182/7-8-2001). Το Εργαστήριο Σ.Υ.Α. υποστηρίζει τη διδασκαλία σχετικών με το αντικείμενό του μαθημάτων σε προπτυχιακό και μεταπτυχιακό επίπεδο, τόσο σε θεωρητικό όσο και σε πρακτικό επίπεδο με την άσκηση των φοιτητών σε ειδικό λογισμικό που υλοποιούν διάφορα μοντέλα υποστήριξης αποφάσεων.</p><br><br>
    <a href="Ereunhtiko_Ergasthrio_id_6.php"><h3>Εργαστήριο Πληροφοριακών Συστημάτων</h3></a>
    <img src="Ereynitika_Ergastiria_id_6.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Το Εργαστήριο Πληροφορικών Συστημάτων ιδρύθηκε το 2001. Είναι θεσμοθετημένο εργαστήριο του Τμήματος Πληροφορικής του Πανεπιστημίου Πειραιώς. Κύριος σκοπός του εργαστηρίου είναι η υποστήριξη των εκπαιδευτικών και ερευνητικών δραστηριοτήτων του Τμήματος Πληροφορικής στο ευρύ επιστημονικό πεδίο των Πληροφοριακών Συστημάτων και των εφαρμογών τους.</p>
    <p>Διευθυντής: Αναπληρωτής Καθηγητής Κ. Μεταξιώτης</p>
    <p>Διεύθυνση: Αίθουσα 604, Γρ. Λαμπράκη 126</p>
</div>
