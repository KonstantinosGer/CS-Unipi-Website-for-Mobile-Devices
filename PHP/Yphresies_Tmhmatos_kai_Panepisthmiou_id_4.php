...
<div id="main">
    <h2>ΕΥΔΟΞΟΣ</h2>
    <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_4.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Η Ηλεκτρονική Υπηρεσία Ολοκληρωμένης Διαχείρισης Συγγραμμάτων Εύδοξος πρόκειται για μία πρωτοποριακή υπηρεσία για την άμεση και ολοκληρωμένη παροχή των Συγγραμμάτων των φοιτητών των Πανεπιστημίων και των ΤΕΙ της επικράτειας.</p><br>
    <a href="https://eudoxus.gr/"><p>ΕΥΔΟΞΟΣ - Ηλεκτρονική Υπηρεσία Ολοκληρωμένης Διαχείρισης Συγγραμμάτων</p></a>
    <br><br><br><br><br><br>
</div>
