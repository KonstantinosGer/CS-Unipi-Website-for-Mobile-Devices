...
<head>
    ...
    <title>Το Πανεπιστήμιο Πειραιώς πρωτοπόρο σε τομείς αιχμής</title>
        ...
        try {
            ...
            foreach ($connection->query($sql) as $row) {
                ...
                if ($row["id"]==15){
                    ...
                    ?>
                    <tr>
                        <td class="td-title"><h4><?php echo $obj->getTitle()?></h4><p><?php echo $obj->getDescription()?></p><a href="https://www.tanea.gr/2015/04/28/greece/education/prwtoporo-se-tomeis-aixmis/" target="_blank">Περισσότερα</a></td>
                    </tr>
                    <?php
                }
            }
