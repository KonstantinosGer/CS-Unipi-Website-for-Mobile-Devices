...
<div id="main">
    <h2>STUDENTS.CS</h2>
    <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_2.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Ο Student Support Server είναι ένας H/Y με λειτουργικό σύστημα GNU/Linux στο Πανεπιστήμιο Πειραιώς. Παρέχει υπηρεσίες ηλεκτρονικού ταχυδρομείου (e-mail) και διαδικτυακού τόπου (web hosting) για τους φοιτητές του τμήματος Πληροφορικής.</p><br>
    <a href="https://students.cs.unipi.gr/"><p>STUDENTS.CS - Students support server</p></a>
