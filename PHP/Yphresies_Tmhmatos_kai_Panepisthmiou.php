...
<head>
    ...
    <title>Υπηρεσίες Τμήματος και Πανεπιστημίου</title>
...
<div id="main">
    <h2>Υπηρεσίες Τμήματος και Πανεπιστημίου</h2><br>
    <table id="table" border = "0"; style="width: 100%; border-collapse: separate; border-spacing: 50px 0;">
        <tr>
            <td style="width: 40%;">
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_9.php"><h3 style="text-align: left">GUNET</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_9.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr style="margin-left: 20px;">
            <td>
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_10.php"><h3>STUDENTS</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_10.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr>
            <td style="width: 40%;">
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_2.php"><h3 style="text-align: left">STUDENTS.CS</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_2.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr style="margin-left: 20px;">
            <td>
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_3.php"><h3>Βιβλιοθήκη</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_3.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr>
            <td style="width: 40%;">
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_4.php"><h3 style="text-align: left">ΕΥΔΟΞΟΣ</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_4.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr style="margin-left: 20px;">
            <td>
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_5.php"><h3>Helpdesk</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_5.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr>
            <td style="width: 40%;">
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_6.php"><h3 style="text-align: left">ΚΕΠΠ</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_6.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr style="margin-left: 20px;">
            <td>
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_7.php"><h3>UNIPI</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_7.jpg" width="150" height="150" >
            </td>
        </tr>
        <tr style="margin-left: 20px;">
            <td>
                <a href="Yphresies_Tmhmatos_kai_Panepisthmiou_id_8.php"><h3>Γρ. Διασύνδεσης</h3></a></td>
            <td>
                <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_8.jpg" width="150" height="150" >
            </td>
        </tr>
    </table>
</div>
