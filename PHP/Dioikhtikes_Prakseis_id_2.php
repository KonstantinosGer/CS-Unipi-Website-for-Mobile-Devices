...
<head>
    ...
    <title>Μονιμοποίηση μέλους ΔΕΠ</title>
            ...
            foreach ($connection->query($sql) as $row) {
                if ($row["id"]==2){
                    ...
                    <tr>
                        ...
                        <td class="td-title"><h4><?php echo $obj->getTitle()?></h4><p><?php echo $obj->getDescription()?></p><a href="istoriko_monimopoiisis-asyrmata-diktya-epikoinwnies.xls" target="_blank">Μονιμοποίηση μέλους ΔΕΠ</a></td>
                    </tr>
                    <?php
                }
            }
