...
<div id="main">
    <h2>Βιβλιοθήκη</h2>
    <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_3.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Από την ιστοσελίδα της Βιβλιοθήκης του Πανεπιστημίου Πειραιά μπορείτε να ενημερωθείτε για τις υπηρεσίες και τη λειτουργία της βιβλιοθήκης. Η ιστοσελίδα επίσης λειτουργεί ως πύλη για τις δικτυακές υπηρεσίες που παρέχονται από τη Βιβλιοθήκη, προσφέροντας πρόσβαση τόσο στον κατάλογο βιβλίων της συλλογής όσο και σε ένα σύνολο βάσεων δεδομένων για την ανάκτηση βιβλιογραφικής πληροφορίας και πλήρους κειμένου επιστημονικών άρθρων.</p><br>
    <a href="https://www.lib.unipi.gr/"><p>Βιβλιοθήκη Πανεπιστημίου Πειραιά</p></a>
    <br><br><br>
</div>
