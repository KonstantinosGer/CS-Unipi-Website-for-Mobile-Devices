...
<div id="main">
    <h2>Εργαστήριο Συστημάτων Υποστήριξης Αποφάσεων</h2>
    <img src="Ereynitika_Ergastiria_id_7.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Το Εργαστήριο Συστημάτων Υποστήριξης Αποφάσεων ιδρύθηκε στο Τμήμα Πληροφορικής του Πανεπιστήμιου Πειραιώς το έτος 2001 (ΠΔ 244/2001 – ΦΕΚ Α 182/7-8-2001). Το Εργαστήριο Σ.Υ.Α. υποστηρίζει τη διδασκαλία σχετικών με το αντικείμενό του μαθημάτων σε προπτυχιακό και μεταπτυχιακό επίπεδο, τόσο σε θεωρητικό όσο και σε πρακτικό επίπεδο με την άσκηση των φοιτητών σε ειδικό λογισμικό που υλοποιούν διάφορα μοντέλα υποστήριξης αποφάσεων.</p>
    <p>Οι ερευνητικές δραστηριότητες του εργαστηρίου εστιάζουν στα πεδία των συστημάτων υποστήριξης αποφάσεων, μεθοδολογιών μέτρησης αποδοτικότητας συστημάτων, πολυκριτηριακής ανάλυσης αποφάσεων, διαχείρισης γνώσης, ανάλυσης δεδομένων και εξόρυξης γνώσης. Αναλαμβάνει δια των μελών του την διοργάνωση ειδικών θεματικών ενοτήτων σε διεθνή συνέδρια Επιχειρησιακής Έρευνας.</p>
    <p>Διευθυντής: Καθηγητής Δημήτριος Δεσπότης</p>
    <p>Διεύθυνση: Αίθουσα 209, κεντρικό κτίριο</p>
    <a href="http://dsslab.cs.unipi.gr/"><p>http://dsslab.cs.unipi.gr</p></a>
</div>
