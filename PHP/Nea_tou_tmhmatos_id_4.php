...
<head>
    ...
    <title>Βραβεία για Διακεκριμένους Νέους Επιστήμονες του Ιδρύματος Μποδοσάκη</title>
...
<div id="main">
    <table id="table" align="center" border="0">
        <tr>
            ...
            <td class="td-title"><h4><?php echo $title?></h4><p><?php echo $description?></p><br><p>Download attachments:</p><a href="orthi_epanalipsi.pdf" target="_blank">Αρχείο Ανακοίνωσης</a></td>
        </tr>
    </table>
</div>
