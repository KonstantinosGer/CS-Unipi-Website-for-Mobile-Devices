...
<div id="main">
    ...
    <table id="table2" align="center" border="0" style="width: 100%;">
        <tr>
            <td><p>Το κτίριο της Γραμματείας του Τμήματος βρίσκεται στον Πειραιά επί της οδού Ζέας 80-82 (1ος όροφος). Η Γραμματεία του Τμήματος εξυπηρετεί τους προπτυχιακούς φοιτητές κάθε Δευτέρα-Τετάρτη-Παρασκευή, 11:30-14:00.</p></td>
        </tr>
    </table>
    ...
    <br>
    <table id="table3" align="center" border="0" style="width: 100%;">
        <tr>
            <td><p>Fax.: 210-4142107</p></td>
        </tr>
    </table>

    <table id="table4" align="center" border="0" style="width: 100%;">
        <tr>
            <td><p>Ομαδική διεύθυνση ηλεκτρονικού ταχυδρομείου Γραμματείας: plh-secr@unipi.gr</p></td>
        </tr>
    </table>
</div>
