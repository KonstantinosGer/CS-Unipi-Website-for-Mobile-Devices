...
<div id="main">
    <h2>UNIPI</h2>
    <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_7.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Η ιστοσελίδα του Πανεπιστημίου Πειραιά.</p><br>
    <a href="https://www.unipi.gr/unipi/el/"><p>Πανεπιστήμιο Πειραιά</p></a>
