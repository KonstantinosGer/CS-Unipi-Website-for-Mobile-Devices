...
<head>
    ...
    <title>ΑΝΑΠΛΗΡΩΤΗΣ ΠΡΟΕΔΡΟΥ</title>
            ...
            foreach ($connection->query($sql) as $row) {
                if ($row["id"]==5){
                    ...
                    <tr>
                        ...
                        <td class="td-title"><h4><?php echo $obj->getTitle()?></h4><p><?php echo $obj->getDescription()?></p><a href="anaplirotis-proedrou-30-6-2016.pdf" target="_blank">ΑΝΑΠΛΗΡΩΤΗΣ ΠΡΟΕΔΡΟΥ</a></td>
                    </tr>
                    <?php
                }
            }
