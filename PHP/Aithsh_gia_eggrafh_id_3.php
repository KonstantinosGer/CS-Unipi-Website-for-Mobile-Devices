...
<div id="main">
    <h2>Πρόσκληση Υποβολής Αιτήσεων
        ΠΜΣ "Κατανεμημένα Συστήματα, Ασφάλεια και Αναδυόμενες Τεχνολογίες Πληροφορίας"</h2>
    <br>
    <div class="type-1">
        <div>
    ...
    <p>Το Τμήμα Πληροφορικής του Πανεπιστημίου Πειραιώς προσκαλεί υποψηφίους μεταπτυχιακούς φοιτητές για υποβολή αιτήσεων με σκοπό τη συμμετοχή στα Προγράμματα Μεταπτυχιακών Σπουδών <b>(ΠΜΣ):"Κατανεμημένα Συστήματα, Ασφάλεια και Αναδυόμενες Τεχνολογίες Πληροφορίας"</b> που διοργανώνει για τον ακαδημαϊκό κύκλο 2020-2021.</p>
    <p>Το ΠΜΣ "Κατανεμημένα Συστήματα, Ασφάλεια και Αναδυόμενες Τεχνολογίες Πληροφορίας" (“Distributed Systems, Security and Emerging Information Technologies”) έχει διάρκεια τριών (3) ακαδημαϊκών εξαμήνων (δυο (2) ακαδημαϊκών εξαμήνων παρακολούθησης μεταπτυχιακών μαθημάτων και ενός (1) ακαδημαϊκού εξαμήνου εκπόνησης μεταπτυχιακής διατριβής) και απονέμει Μεταπτυχιακό Δίπλωμα Ειδίκευσης (ΜΔΕ) στα «Κατανεμημένα Συστήματα, Ασφάλεια και Αναδυόμενες Τεχνολογίες Πληροφορίας» στις εξής κατευθύνσεις:</p>
    <p>α) Διάχυτα Υπολογιστικά Συστήματα και Αρχιτεκτονικές / Pervasive Computing Systems and Architectures (ΔΥΣΑ/PCSA). </p>
    <p>β) Τεχνολογίες και Διαχείριση Ασφάλειας Υπολογιστικών Συστημάτων / Computing Systems Security Management and Engineering (ΤΕΔΑ/CSSME).</p>
    <p>γ) Επιχειρηματική Αναλυτική και Αναδυόμενες Τεχνολογίες Πληροφορίας / Business Analytics and Emerging Information Technologies (ΕΑΑΤΠ/BAEIT).</p>
    <p>Στο ΠΜΣ γίνονται δεκτοί, μετά από επιλογή, κάτοχοι τίτλου πρώτου κύκλου σπουδών Α.Ε.Ι. της ημεδαπής ή ομοταγών ιδρυμάτων της αλλοδαπής σύμφωνα με τις διατάξεις του άρθρου 34 του ν. 4485/2017, κατά προτεραιότητα πτυχιούχοι Τμημάτων Πληροφορικής, Σχολών Τεχνολογιών Πληροφορικής και Επικοινωνιών, Πολυτεχνείων ή Πολυτεχνικών Σχολών, Τμημάτων Θετικών Επιστημών Πανεπιστημίων, Μηχανικών Πληροφορικής Τ.Ε., Μηχανικών Τ.Ε., Σχολών Θετικών ή Τεχνολογικών Επιστημών ή/και άλλων συναφών με τις κατευθύνσεις ειδικοτήτων. Η έναρξη των μαθημάτων θα πραγματοποιηθεί εντός Οκτωβρίου 2020.</p>
    <p>Οι ενδιαφερόμενοι μπορούν να υποβάλουν αιτήσεις από 19 Μαρτίου 2020 έως και 15 Σεπτεμβρίου 2020.</p>
    <p>Οι υποψήφιοι πρέπει να υποβάλουν ηλεκτρονικά την αίτηση στον διαδικτυακό τόπο: http://www.cs.unipi.gr/registration/distributed.php και να αποστείλουν την αίτηση και τα κάτωθι δικαιολογητικά αναγράφοντας το Ονοματεπώνυμό τους στο e-mail psp@unipi.gr. Οι αιτήσεις γίνονται δεκτές και ταχυδρομικώς εφόσον αποσταλούν προς το Τμήμα Πληροφορικής του Πανεπιστημίου Πειραιώς, μέχρι την καταληκτική ημερομηνία. Τα σχετικά έγγραφα είναι τα ακόλουθα:</p>
    ...
    <p>Περισσότερες πληροφορίες μπορείτε να αναζητήσετε στην ηλεκτρονική διεύθυνση του Μεταπτυχιακού "Κατανεμημένα Συστήματα, Ασφάλεια και Αναδυόμενες Τεχνολογίες Πληροφορίας": http://www.cs.unipi.gr/distributed</p>
    <p><u>Κριτήρια επιλογής για την αξιολόγηση και κατάταξη υποψηφίων του ΠΜΣ«Κατανεμημένα Συστήματα, Ασφάλεια και Αναδυόμενες Τεχνολογίες Πληροφορίας»</u></p>
    ...
    <p><b>Διεύθυνση Π.Μ.Σ "Κατανεμημένα Συστήματα, Ασφάλεια και Αναδυόμενες Τεχνολογίες Πληροφορίας":</b></p>
