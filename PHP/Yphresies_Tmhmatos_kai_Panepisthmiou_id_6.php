...
<div id="main">
    <h2>ΚΕΠΠ</h2>
    <img src="Yphresies_Tmhmatos_kai_Panepisthmiou_id_6.jpg" width="150" height="150" style="float: left; margin-right: 10px; margin-bottom: 5px";>
    <p>Το Κέντρο Ερευνών Πανεπιστημίου Πειραιώς (Κ.Ε.Π.Π.) στα πλαίσια του θεσμικού πλαισίου που διέπει τη λειτουργία του, έχει θέσει ως όραμα το να καταστεί ένα σύγχρονο και διεθνούς φήμης ερευνητικό κέντρο το οποίο θα συμβάλλει στην ανάδειξη και αναγνώριση του Πανεπιστημίου Πειραιώς ως ενός εκ των κορυφαίων της Ευρώπης.</p><br>
    <a href="http://www.kep.unipi.gr/"><p>ΚΕΠΠ - Κέντρο Ερευνών Πανεπιστημίου Πειραιά</p></a>
    <br><br><br><br><br>
</div>
