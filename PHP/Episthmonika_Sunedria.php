...
<head>
    ...
    <title>Επιστημονικά Συνέδρια</title>
...
<div id="main">
    <h1>Επιστημονικά Συνέδρια</h1>

    <table id="table2" align="center" border="0" style="width: 100%;">
        <tr>
            <td><p>Το Τμήμα Πληροφορικής έχει συμμετάσχει στη διοργάνωση των παρακάτω επιστημονικών συνεδρίων:</p></td>
        </tr>
    </table>
