...
<head>
    ...
    <title>Το Πανεπιστήμιο Πειραιώς στα 100 Κορυφαία Πανεπιστήμια του Κόσμου για Computer Education Σύμφωνα με το Εργαλείο Ακαδημαϊκής Αναζήτησης της Microsoft</title>
...
<div id="main">
    <table id="table" align="center" border="0" style="width: 100%;">
        ...
        try {
            ...
            $connection = new PDO("pgsql:host=localhost;dbname=cs_unipi_database", "postgres", "polifolio68");
            #Query
            $sql = 'SELECT * from diakriseis ORDER BY id desc';
            ...
            foreach ($connection->query($sql) as $row) {
                ...
                if ($row["id"]==13){
                    ...
                    ?>
                    <tr>
                        <td class="td-title"><h4><?php echo $obj->getTitle()?></h4><p><?php echo $obj->getDescription()?></p><a href="http://academic.research.microsoft.com/RankList?entitytype=7&topDomainID=2&subDomainID=23&last=0&start=1&end=100" target="_blank">http://academic.research.microsoft.com/RankList?entitytype=7&topDomainID=2&subDomainID=23&last=0&start=1&end=100</a></td>
                    </tr>
                    <?php
                }
            }
