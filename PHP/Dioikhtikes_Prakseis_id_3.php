            ...
            foreach ($connection->query($sql) as $row) {
                if ($row["id"]==3){
                    ...
                    <tr>
                        ...
                        <td class="td-title"><h4><?php echo $obj->getTitle()?></h4><p><?php echo $obj->getDescription()?></p><a href="prokirixi-stpe-ada-26-02-2016.pdf" target="_blank">Πρόσκληση εκδήλωσης ενδιαφέροντος για την πρόσληψη εκπαιδευτικού προσωπικού με σχέση εργασίας ιδιωτικού δικαίου ορισμένου χρόνου</a></td>
                    </tr>
                    <?php
                }
            }
